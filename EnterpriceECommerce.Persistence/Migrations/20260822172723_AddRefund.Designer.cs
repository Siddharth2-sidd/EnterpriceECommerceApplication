...
namespace EnterpriceECommerce.Persistence.Migrations
{
    ...
    [Migration("20260822172723_AddRefund")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Refund", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedOn = new DateTime(2026, 8, 22, 22, 57, 22, 298, DateTimeKind.Local).AddTicks(3627),
                            Name = "Admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedOn = new DateTime(2026, 8, 22, 22, 57, 22, 298, DateTimeKind.Local).AddTicks(3645),
                            Name = "Seller"
                        },
                        new
                        {
                            Id = 3,
                            CreatedOn = new DateTime(2026, 8, 22, 22, 57, 22, 298, DateTimeKind.Local).AddTicks(3648),
                            Name = "Customer"
                        });
                });
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.WishListItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.CartItem", b =>
                {
                    b.HasOne("EnterpriceECommerce.Domain.Entitites.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.OrderItem", b =>
                {
                    b.HasOne("EnterpriceECommerce.Domain.Entitites.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("EnterpriceECommerce.Domain.Entitites.Refund", b =>
                {
                    b.HasOne("EnterpriceECommerce.Domain.Entitites.Payment", "Payment")
                        .WithMany()
